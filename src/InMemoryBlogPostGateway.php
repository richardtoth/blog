...
class InMemoryBlogPostGateway implements BlogPostBySlugGatewayInterface, BlogPostLatestPostsGatewayInterface{
        ...
        usort($blogPosts,
            function($firstPost, $secondPost) {
                ...
                if ($firstPost->getPublishedAt()->getTimestamp() > $secondPost->getPublishedAt()->getTimestamp()) {
                    return -1;
                } else if ($firstPost->getPublishedAt()->getTimestamp() < $secondPost->getPublishedAt()->getTimestamp()) {
                    return 1;
                } else {
                    return 0;
                }
