...
/**
 * @covers Refaktor\Blog\InMemoryBlogPostGateway
 */
class InMemoryBlogPostGatewayTest extends \PHPUnit_Framework_TestCase {
    /**
     * @covers Refaktor\Blog\InMemoryBlogPostGateway::getBySlug()
     */
    ...
    /**
     * @covers Refaktor\Blog\InMemoryBlogPostGateway::getOrderedByDate
     */
